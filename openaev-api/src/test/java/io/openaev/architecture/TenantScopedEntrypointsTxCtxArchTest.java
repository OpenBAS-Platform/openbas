...
class TenantScopedEntrypointsTxCtxArchTest {
  ...
  private static final Set<String> TX_SCOPED_ENTRYPOINTS =
      Set.of(
          ...
          // injects (v2): own API endpoints reading/writing inject rows.
          ...
          "io.openaev.rest.inject.InjectApi#targetOptionsById",
          ...
          // injects (v2): indirect inject reads in challenge/article projections.
