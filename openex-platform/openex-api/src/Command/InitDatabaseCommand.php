...
class InitDatabaseCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $userDemo = $this->createUser('demo@openex.io', 'demo', 'Demo', 'Openex', true, false, $organizationAgency);
        ...
        $userJane = $this->createUser('jane@openex.io', 'jane', 'Jane', 'Doe', true, false, $organizationAgency);
        ...
        $userJerry = $this->createUser('jerry@openex.io', 'jerry', 'Jerry', 'Doe', true, false, $organizationAgency);
        ...
        $userSam = $this->createUser('sam@openex.io', 'sam', 'Sam', 'Doe', true, false, $organizationAgency);
        ...
        $userRick = $this->createUser('rick@openex.io', 'rick', 'Rick', 'Grimes', false, false, $organizationPolice);
        $output->writeln('Creating user rick@openex.io with password rick');

        $tokenRick = $this->createToken($userRick);
        $output->writeln('Creating token for user rick: ' . $tokenRick->getTokenValue());
        ...
        $this->joinGroup($userRick, $groupPotatoesPlanners);
        $output->writeln('Rick is joining group \'Potatoes planners\'');

        $this->joinGroup($userJerry, $groupCockroachPlanners);
        $output->writeln('Jerry is joining group \'Cockroach planners\'');

        $this->joinGroup($userRick, $groupCockroachPlanners);
        $output->writeln('Rick is joining group \'Cockroach planners\'');
        ...
        $subaudienceAirforce = $this->createSubaudience('Air force', $audienceDefence, [$userSam, $userJane, $userRick]);
        ...
        $subaudiencePress = $this->createSubaudience('Press relations', $audienceMedia, [$userSam, $userJane, $userJerry, $userRick]);
        ...
        $incidentSpy = $this->createIncident(
            'A potato is infiltrated',
    ...
    private function createExercise($name, $subtitle, $description, $startDate, $endDate, $owner, $image)
    {
        ...
        $exercise->setExerciseMailExpediteur('admin@openex.io');
