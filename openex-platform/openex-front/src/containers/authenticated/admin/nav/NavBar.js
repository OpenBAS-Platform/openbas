    ...
    return (
      <Drawer width={65} docked={true} open={true} zindex={50}>
        <AppBar
          ...
          iconElementLeft={
            this.props.loading ? <CircularSpinner size={30} /> : undefined
          }
        />
        <List>
          <IconListItemLink
            ...
            leftIcon={
              <Icon
                type={Constants.ICON_TYPE_NAVBAR}
          ...
          />
          <IconListItemLink
            active={this.props.pathname.includes('/private/admin/groups')}
          ...
          />
          <IconListItemLink
            active={this.props.pathname.includes('/private/admin/tests')}
