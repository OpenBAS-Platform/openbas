...
export const TagListe = (props) => (
    <MUIChip style={chipTagListe}
        onClick={props.onClick}
        onRequestDelete={props.onRequestDelete}
        labelStyle={chipTagListeLabelStyle}>{ (props.value.length > 25) ? props.value.substring(0, 25)+'...' : props.value}</MUIChip>
)
...
export const TagSmallListe = (props) => (
    <MUIChip
        style={chipSmallTagListe}
        labelStyle={chipSmallTagListeLabelStyle}>{ (props.value.length > 25) ? props.value.substring(0, 25)+'...' : props.value}</MUIChip>
)
...
export const TagExerciseListe = (props) => (
    <MUIChip
        ...
        onClick={props.onClick}
        labelStyle={chipTagExerciseListeLabelStyle}> { (props.value.length > 25) ? props.value.substring(0, 25)+'...' : props.value} </MUIChip>
)
...
export const TagSmallExerciseListe = (props) => (
    <MUIChip
        ...
        onClick={props.onClick}
        labelStyle={chipSmallTagExerciseListeLabelStyle}> { (props.value.length > 25) ? props.value.substring(0, 25)+'...' : props.value} </MUIChip>
)
...
export const TagAddToFilter = (props) => (
    <MUIChip
        ...
        onRequestDelete={props.onRequestDelete}
        labelStyle={chipTagAddToFilterLabelStyle}>{(props.value.length > 25) ? props.value.substring(0, 25)+'...' : props.value}</MUIChip>
)
