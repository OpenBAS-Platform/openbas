...
i18nRegister({
  fr: {
    'Do you want to delete this log entry?': 'Souhaitez-vous supprimer cette entrée du journal ?',
...
class LogPopover extends Component {
  ...
  onSubmitEdit(data) {
    return this.props.updateLog(this.props.exerciseId, this.props.log.log_id, data)
  }
  ...
  render() {
    ...
    let initialValues = R.pick(['log_title', 'log_content'], this.props.log)
    return (
      <div style={style}>
        ...
        <Dialog title="Update the log entry" modal={false} open={this.state.openEdit}
                onRequestClose={this.handleCloseEdit.bind(this)}
                actions={editActions}>
          <LogForm ref="logForm" initialValues={initialValues}
