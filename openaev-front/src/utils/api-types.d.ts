...
export interface InjectExpectationOutput {
  ...
  /** True when this technical detection/prevention expectation required a security platform collector to be fulfilled but none was connected at initialization, so it was resolved as a definitive failure instead of staying pending. Frozen at creation time (a collector connected later does not clear it). The UI surfaces a "no automated security platform" message. */
