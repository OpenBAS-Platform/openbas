...
public class InjectExpectationServiceTest extends IntegrationTest {
  ...
  @BeforeEach
  void beforeEach() {
    injector = InjectorFixture.createInjector("49229430-b5b5-431f-ba5b-f36f599b0144", "OpenBAS Implant",
        "openbas_implant");
    injectorContract = InjectorContractFixture.createInjectorContract("84b3b140-6b7d-47d9-9b61-8fa05882fc7e",
