...
public class ExpectationApiTest extends IntegrationTest {
  ...
  class ResultInjectExpectation {
    ...
    void updateAssetGroupInjectExpectationResults() throws Exception {
      ...
      // Delete results from Assert group
    ...
    void updateAssetInjectExpectationResults() throws Exception {
      ...
      injectExpectationService.buildAndSaveInjectExpectations(
          executableInject, List.of(detectionExpectationForAsset));
  ...
  class ProcessInjectExpectationsForCollectors {
    ...
    void getInjectPreventionExpectationsForSource() throws Exception {
      ...
      injectExpectationService.buildAndSaveInjectExpectations(
          executableInject, List.of(preventionExpectationForAsset));
    ...
    @Test
    @DisplayName("Update Inject expectation from collector")
    void updateInjectExpectation() throws Exception {
      ...
      injectExpectationService.buildAndSaveInjectExpectations(
          executableInject,
          List.of(detectionExpectationForAssetGroup, detectionExpectationForAsset));
