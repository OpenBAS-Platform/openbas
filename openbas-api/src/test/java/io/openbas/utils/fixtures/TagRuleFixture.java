...
public class TagRuleFixture {
    public  final static String TAG_RULE_ID = "tagruleid";
    public final static String TAG_RULE_ID_2 = "tagruleid2";
    public final static String TAG_NAME = "testtag";
    public final static String ASSET_ID_1 = "asset1";
    public final static String ASSET_ID_2 = "asset2";
    public final static String ASSET_NAME_1 = "name 1";
    public final static String ASSET_NAME_2 = "name 2";
    ...
    public static TagRuleOutput createTagRuleOutput() {
        return TagRuleOutput.builder().tagName(TAG_NAME).assets(Map.ofEntries(
                Map.entry(ASSET_ID_1, ASSET_NAME_1),
                Map.entry(ASSET_ID_2, ASSET_NAME_1))).build();
    }
    public static  TagRuleInput createTagRuleInput(){
        return TagRuleInput.builder().tagName(TagRuleFixture.TAG_NAME).assets(List.of(ASSET_ID_1, ASSET_ID_2)).build();
    }
