  ...
  public static Map<String, Contract> getContracts() {
    return Map.of("1108ad8f8-32f8-4a22-8114-aaa12322bd09",
        ...
        Contract.executableContract(
            ...
            contractBuilder()
                .mandatory(
                    textField("subject", "Subject email", "New channel pressure entries published for ${user.email}",
        ...
        Contract.executableContract(
            new ContractConfig("openbas_http",
        ...
        Contract.executableContract(
            new ContractConfig("openbas_ovh_sms",
