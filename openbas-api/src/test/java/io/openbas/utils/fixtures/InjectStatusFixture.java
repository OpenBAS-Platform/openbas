...
public class InjectStatusFixture {
  ...
  public static InjectStatus createDefaultInjectStatus() {
    ...
    injectStatus.setPayloadOutput(new StatusPayload(null, null, null, null, null, null, null, null, null, null, null,
        List.of(new PayloadCommandBlock("cmd", "content", List.of("clean cmd"))), "cmd"));
    return injectStatus;
  }
}
