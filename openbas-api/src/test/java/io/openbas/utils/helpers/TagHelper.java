...
public class TagHelper {
  public static List<Tag> crawlAllExerciseTags(Exercise exercise, ChallengeService challengeService) {
  ...
  public static List<Tag> crawlAllScenarioTags(Scenario scenario, ChallengeService challengeService) {
