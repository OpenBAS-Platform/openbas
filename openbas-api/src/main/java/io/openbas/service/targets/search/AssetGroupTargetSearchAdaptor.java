...
public class AssetGroupTargetSearchAdaptor extends SearchAdaptorBase {
  ...
  public AssetGroupTargetSearchAdaptor(AssetGroupCriteriaBuilderService assetGroupCriteriaBuilderService, InjectExpectationService injectExpectationService) {
  ...
  private InjectTarget convertFromAssetGroupOutput(AssetGroupOutput assetGroupOutput, Inject inject) {
    AssetGroupTarget target = new AssetGroupTarget(
            assetGroupOutput.getId(), assetGroupOutput.getName(), assetGroupOutput.getTags());

    List<AtomicTestingUtils.ExpectationResultsByType> results = AtomicTestingUtils.getExpectationResultByTypes(
