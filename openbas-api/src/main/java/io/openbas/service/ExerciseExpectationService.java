...
public class ExerciseExpectationService {
  ...
  public InjectExpectation updateInjectExpectation(
    ...
    if (exists.isPresent()) {
      ...
      injectExpectation
          .getResults()
          .add(buildInjectExpectationResult(input.getSourceType(), result, input.getScore()));
    }
      ...
      parentExpectation
          ...
          .add(
              buildInjectExpectationResult(
                  "player-manual-validation", result, parentExpectation.getScore()));
      ...
      for (InjectExpectation expectation : toProcess) {
        ...
        if (result != null) {
          expectation
              ...
              .add(
                  buildInjectExpectationResult(
                      "team-manual-validation", result, updated.getScore()));
        }
  ...
  private InjectExpectationResult buildInjectExpectationResult(
      String type, String resultStatus, Double score) {
