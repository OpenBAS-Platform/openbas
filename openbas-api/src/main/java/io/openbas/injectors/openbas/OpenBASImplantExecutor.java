                    ...
                    if (injectorContract.getPayload() != null) {
                      ...
                      switch (injectorContract.getPayload().getType()) {
                        case "Command":
                          ...
                          if (payloadCommand.getCleanupCommand() != null && !payloadCommand.getCleanupCommand().isEmpty()) {
                            totalActionsCount = totalActionsCount + 1;
                          }
                          break;
                        case "Executable":
                          ...
                          if (payloadExecutable.getCleanupCommand() != null && !payloadExecutable.getCleanupCommand().isEmpty()) {
                            totalActionsCount = totalActionsCount + 1;
                          }
                          // TODO File hash
                          break;
                        case "FileDrop":
                          ...
                          if (payloadFileDrop.getCleanupCommand() != null && !payloadFileDrop.getCleanupCommand().isEmpty()) {
                            totalActionsCount = totalActionsCount + 1;
                          }
                          // TODO File hash
                          break;
                        case "DnsResolution":
                          ...
                          if (payloadDnsResolution.getCleanupCommand() != null && !payloadDnsResolution.getCleanupCommand().isEmpty()) {
                            totalActionsCount = totalActionsCount + 1;
                          }
                          break;
                        default:
