...
public class AssetGroupApi extends RestBehavior {
  ...
  @RBAC(requiredAction = Action.WRITE, resourceType = ResourceType.ASSET)
  ...
  @RBAC(requiredAction = Action.READ, resourceType = ResourceType.ASSET)
  ...
  @RBAC(requiredAction = Action.SEARCH, resourceType = ResourceType.ASSET)
  @PreAuthorize("isObserver()")
