...
public class PayloadApi extends RestBehavior {
  ...
  @RBAC(requiredAction = Action.SEARCH, resourceType = ResourceType.PAYLOAD)
  ...
  @RBAC(requiredAction = Action.WRITE, resourceType = ResourceType.PAYLOAD)
  ...
  @RBAC(
      resourceId = "#payloadId",
      requiredAction = Action.DUPLICATE,
      resourceType = ResourceType.PAYLOAD)
  @PreAuthorize("isPlanner()")
  @Transactional(rollbackOn = Exception.class)
  ...
  @RBAC(requiredAction = Action.READ, resourceType = ResourceType.PAYLOAD)
