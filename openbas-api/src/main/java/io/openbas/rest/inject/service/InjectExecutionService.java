...
public class InjectExecutionService {
  ...
  public void handleInjectExecutionCallback(
    ...
    try {
      ...
      Set<OutputParser> outputParsers = structuredOutputUtils.extractOutputParsers(execution.getInject());
  ...
  private void processInjectExecution(
    ...
    if (structured != null) {
      if (agent != null) {
        ...
        findingService.extractFindingsFromOutputParsers(execution, agent, outputParsers, structured);
      } else {
