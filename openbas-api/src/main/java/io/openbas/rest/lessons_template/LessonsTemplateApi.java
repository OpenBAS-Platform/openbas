...
public class LessonsTemplateApi extends RestBehavior {
  ...
  @RBAC(requiredAction = Action.WRITE, resourceType = ResourceType.LESSON_LEARNED)
  ...
  @RBAC(requiredAction = Action.READ, resourceType = ResourceType.LESSON_LEARNED)
  ...
  @RBAC(requiredAction = Action.SEARCH, resourceType = ResourceType.LESSON_LEARNED)
