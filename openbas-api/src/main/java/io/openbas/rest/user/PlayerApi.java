...
public class PlayerApi extends RestBehavior {
  ...
  @RBAC(requiredAction = Action.READ, resourceType = ResourceType.PLAYER)
  ...
  @RBAC(requiredAction = Action.SEARCH, resourceType = ResourceType.PLAYER)
  ...
  @RBAC(resourceId = "#userId", requiredAction = Action.READ, resourceType = ResourceType.PLAYER)
  ...
  @RBAC(requiredAction = Action.WRITE, resourceType = ResourceType.PLAYER)
  @PreAuthorize("isPlanner()")
  @Transactional(rollbackOn = Exception.class)
  ...
  @RBAC(resourceId = "#userId", requiredAction = Action.WRITE, resourceType = ResourceType.PLAYER)
  @PreAuthorize("isPlanner()")
  ...
  @RBAC(resourceId = "#userId", requiredAction = Action.DELETE, resourceType = ResourceType.PLAYER)
  @PreAuthorize("isPlanner()")
