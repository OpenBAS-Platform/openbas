...
public class NotificationRuleApi {
  ...
  @RBAC(requiredAction = Action.READ, resourceType = ResourceType.NOTIFICATION_RULE)
  ...
  @RBAC(requiredAction = Action.SEARCH, resourceType = ResourceType.NOTIFICATION_RULE)
  ...
  @RBAC(requiredAction = Action.WRITE, resourceType = ResourceType.NOTIFICATION_RULE)
  @Transactional(rollbackFor = Exception.class)
