...
public class FindingApi extends RestBehavior {
  ...
  @GetMapping("/{id}")
  @RBAC(resourceId = "#id", requiredAction = Action.READ, resourceType = ResourceType.FINDING)
  ...
  @PostMapping
  @RBAC(requiredAction = Action.WRITE, resourceType = ResourceType.FINDING)
  ...
  @PutMapping("/{id}")
  @RBAC(resourceId = "#id", requiredAction = Action.WRITE, resourceType = ResourceType.FINDING)
  ...
  @DeleteMapping("/{id}")
  @RBAC(resourceId = "#id", requiredAction = Action.DELETE, resourceType = ResourceType.FINDING)
