...
public class SecurityPlatformApi {
  ...
  @RBAC(requiredAction = Action.READ, resourceType = ResourceType.SECURITY_PLATFORM)
  ...
  @RBAC(requiredAction = Action.WRITE, resourceType = ResourceType.SECURITY_PLATFORM)
  ...
  @RBAC(requiredAction = Action.SEARCH, resourceType = ResourceType.SECURITY_PLATFORM)
