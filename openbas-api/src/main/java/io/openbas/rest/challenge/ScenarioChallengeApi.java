...
public class ScenarioChallengeApi extends RestBehavior {
  ...
  public Iterable<ChallengeOutput> scenarioChallenges(@PathVariable @NotBlank final String scenarioId) {
    ...
    return fromIterable(this.challengeRepository.findAllById(challengeIds))
        .stream()
