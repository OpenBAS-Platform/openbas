...
public class TeamApi extends RestBehavior {
  ...
  @LogExecutionTime
  @GetMapping(TEAM_URI)
  @RBAC(requiredAction = Action.READ, resourceType = ResourceType.TEAM)
  ...
  @RBAC(requiredAction = Action.SEARCH, resourceType = ResourceType.TEAM)
  @PreAuthorize("isObserver()")
  ...
  @RBAC(resourceId = "#teamId", requiredAction = Action.READ, resourceType = ResourceType.TEAM)
  @PreAuthorize("isObserver()")
  ...
  @RBAC(requiredAction = Action.WRITE, resourceType = ResourceType.TEAM)
  ...
  @RBAC(resourceId = "#teamId", requiredAction = Action.DELETE, resourceType = ResourceType.TEAM)
  @PreAuthorize("isPlanner()")
  ...
  @RBAC(resourceId = "#teamId", requiredAction = Action.WRITE, resourceType = ResourceType.TEAM)
  @PreAuthorize("isPlanner()")
