...
public class AiApi extends RestBehavior {
    ...
    public ResponseEntity<Flux<AiResult>> aiFixSpelling(@Valid @RequestBody final AiGenericTextInput aiGenericTextInput) throws JsonProcessingException {
        if (!aiConfig.isEnabled()) {
    ...
    public ResponseEntity<Flux<AiResult>> aiMakeShorter(@Valid @RequestBody final AiGenericTextInput aiGenericTextInput) throws JsonProcessingException {
        if (!aiConfig.isEnabled()) {
            throw new UnsupportedOperationException("AI is disabled in this platform, please ask your administrator.");
        }
        String prompt = "\n" +
    ...
    public ResponseEntity<Flux<AiResult>> aiMakeLonger(@Valid @RequestBody final AiGenericTextInput aiGenericTextInput) throws JsonProcessingException {
        if (!aiConfig.isEnabled()) {
            throw new UnsupportedOperationException("AI is disabled in this platform, please ask your administrator.");
        }
        String prompt = "\n" +
    ...
    public ResponseEntity<Flux<AiResult>> aiChangeTone(@Valid @RequestBody final AiGenericTextInput aiGenericTextInput) throws JsonProcessingException {
        if (!aiConfig.isEnabled()) {
            throw new UnsupportedOperationException("AI is disabled in this platform, please ask your administrator.");
        }
        String prompt = "\n" +
    ...
    public ResponseEntity<Flux<AiResult>> aiSummarize(@Valid @RequestBody final AiGenericTextInput aiGenericTextInput) throws JsonProcessingException {
        if (!aiConfig.isEnabled()) {
            throw new UnsupportedOperationException("AI is disabled in this platform, please ask your administrator.");
        }
        String prompt = "\n" +
    ...
    public ResponseEntity<Flux<AiResult>> aiGenerateMessage(@Valid @RequestBody final AiMessageInput aiMessageInput) throws JsonProcessingException {
        if (!aiConfig.isEnabled()) {
            throw new UnsupportedOperationException("AI is disabled in this platform, please ask your administrator.");
        }
        String prompt = "\n" +
    ...
    public ResponseEntity<Flux<AiResult>> aiGenerateSubject(@Valid @RequestBody final AiMessageInput aiMessageInput) throws JsonProcessingException {
        if (!aiConfig.isEnabled()) {
            throw new UnsupportedOperationException("AI is disabled in this platform, please ask your administrator.");
        }
        String prompt = "\n" +
    ...
    public ResponseEntity<Flux<AiResult>> aiGenerateMedia(@Valid @RequestBody final AiMediaInput aiMediaInput) throws JsonProcessingException {
        if (!aiConfig.isEnabled()) {
            throw new UnsupportedOperationException("AI is disabled in this platform, please ask your administrator.");
        }
        String prompt = "\n" +
