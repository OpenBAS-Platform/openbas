...
public class CustomDashboardWidgetApi extends RestBehavior {
  ...
  @PostMapping
  @RBAC(resourceId = "#id", requiredAction = Action.WRITE, resourceType = ResourceType.DASHBOARD)
  ...
  @GetMapping
  @RBAC(resourceId = "#id", requiredAction = Action.READ, resourceType = ResourceType.DASHBOARD)
