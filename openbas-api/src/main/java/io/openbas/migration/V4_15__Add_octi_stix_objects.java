...
@Component
public class V4_15__Add_octi_stix_objects extends BaseJavaMigration {
    ...
    try (Statement statement = connection.createStatement()) {
      statement.execute(
          ...
          CREATE TABLE security_assessments (
              ...
              security_assessment_scenario VARCHAR(255) FOREIGN KEY (security_assessment_scenario) REFERENCES scenario(scenario_id) ON DELETE SET NULL,
              ...
              security_assessment_attack_pattern_refs TEXT[],
              security_assessment_vulnerabilities_refs TEXT[],
