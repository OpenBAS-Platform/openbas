...
public class V2_23__Tags_cascade extends BaseJavaMigration {
    ...
    public void migrate(Context context) throws Exception {
        ...
        select.execute("ALTER TABLE injects_tags " +
        ...
        select.execute("ALTER TABLE exercises_tags " +
                "ADD CONSTRAINT tag_id_fk FOREIGN KEY (tag_id) REFERENCES tags(tag_id)  " +
                "ON DELETE CASCADE;");
        select.execute("ALTER TABLE exercises_tags " +
        ...
        select.execute("ALTER TABLE organizations_tags " +
                "ADD CONSTRAINT tag_id_fk FOREIGN KEY (tag_id) REFERENCES tags(tag_id)  " +
                "ON DELETE CASCADE;");
        select.execute("ALTER TABLE organizations_tags " +
        ...
        select.execute("ALTER TABLE users_tags " +
                "ADD CONSTRAINT tag_id_fk FOREIGN KEY (tag_id) REFERENCES tags(tag_id)  " +
                "ON DELETE CASCADE;");
        select.execute("ALTER TABLE users_tags " +
