...
public class V2_2__Simplify_model extends BaseJavaMigration {
    ...
    public void migrate(Context context) throws Exception {
        ...
        select.execute("ALTER TABLE outcomes ADD constraint fk_outcome_inject " +
        ...
        select.execute("ALTER TABLE injects ADD constraint fk_inject_exercise " +
        ...
        select.execute("ALTER TABLE subaudiences ADD constraint fk_audience_exercise " +
        ...
        select.execute("ALTER TABLE comchecks ADD constraint fk_comcheck_audience " +
        ...
        select.execute("ALTER TABLE subaudiences RENAME COLUMN subaudience_enabled TO audience_enabled;");
        ...
        select.execute("ALTER TABLE exercises ADD constraint fk_exercise_image " +
