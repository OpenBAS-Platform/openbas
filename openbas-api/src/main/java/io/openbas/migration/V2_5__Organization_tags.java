...
public class V2_5__Organization_tags extends BaseJavaMigration {
    ...
    public void migrate(Context context) throws Exception {
        ...
        select.execute("ALTER TABLE organizations ADD organization_created_at timestamp not null default now();");
        select.execute("ALTER TABLE organizations ADD organization_updated_at timestamp not null default now();");
    }
}
