...
public class FullTextSearchApi extends RestBehavior {
  ...
  public Map<? extends Class<? extends Base>, FullTextSearchService.FullTextSearchCountResult> fullTextSearch(@Valid @RequestBody final SearchTerm searchTerm) {
  ...
  public Page<FullTextSearchService.FullTextSearchResult> fullTextSearch(
      ...
      @RequestBody @Valid SearchPaginationInput searchPaginationInput) throws ClassNotFoundException {
