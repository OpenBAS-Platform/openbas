...
export const SCENARIO_INJECT_BASE_URL = '/admin/injects';
export const SIMULATION_INJECT_BASE_URL = '/admin/injects';
...
export const ASSET_BASE_URL = '/admin/assets/endpoints';
export const CHANNEL_BASE_URL = '/admin/components/channels';
export const ARTICLE_BASE_URL = '/admin/articles';
export const TAG_BASE_URL = '/admin/tags';
