...
const i18n = {
  messages: {
    fr: {
      ...
      // Agent installation
      'Choose Platform': 'Choisissez la plateforme',
      ...
      'Run the following PowerShell snippet in a standard prompt or download the .ps1 script (update parameters as needed).': 'Exécutez le code PowerShell suivant dans un invite de commande standard ou téléchargez le script .ps1 (mettez à jour les paramètres si nécessaire).',
      ...
      'documentation.': 'documentation.',
      'Install the agent using your own user account. This installation requires only local standard privileges.': 'Installez l\'agent en utilisant votre propre compte utilisateur. Cette installation nécessite uniquement des privilèges locaux standard.',
