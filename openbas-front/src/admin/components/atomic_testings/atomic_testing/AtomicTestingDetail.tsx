...
import { getInjectExecutionWithGlobalExecutionTraces } from '../../../../actions/injects/inject-action';
import { useFormatter } from '../../../../components/i18n';
import Loader from '../../../../components/Loader';
import { type InjectResultOverviewOutput, type InjectExecutionOutput } from '../../../../utils/api-types';
...
const AtomicTestingDetail: FunctionComponent = () => {
  ...
  const [injectStatus, setInjectStatus] = useState<InjectExecutionOutput | null>(null);
  const [loading, setLoading] = useState<boolean>(true);

  useEffect(() => {
    if (injectId) {
      setLoading(true);
      getInjectExecutionWithGlobalExecutionTraces(injectId)
