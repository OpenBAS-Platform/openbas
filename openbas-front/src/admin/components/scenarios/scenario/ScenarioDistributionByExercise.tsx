    ...
    return Array.from(Array(5), (e, i) => {
      ...
      return {
        ...
        exercise_global_score: [
          { type: 'PREVENTION', distribution: [{ id: 'PARTIAL', value: 0.69, label: t('Unknown') }], avgResult: 'PARTIAL' },
          { type: 'DETECTION', distribution: [{ id: 'PARTIAL', value: 0.84, label: t('Unknown') }], avgResult: 'PARTIAL' },
          { type: 'HUMAN_RESPONSE', distribution: [{ id: 'PARTIAL', value: 0.46, label: t('Unknown') }], avgResult: 'PARTIAL' },
        ],
        exercise_targets: [],
