...
const ExpectationDistributionByInjectorContract: FunctionComponent<Props> = ({
  exerciseId,
}) => {
  // Standard hooks
  ...
  const expectationsByInjectorContractData = [
    {
      ...
      data: sortedInjectorContractsWithScoreByNumber.map((a: InjectStore & { number: number }) => ({
...
export default ExpectationDistributionByInjectorContract;
