...
const ExpectationDistributionByInjectType: FunctionComponent<Props> = ({
  exerciseId,
}) => {
  // Standard hooks
  ...
  const expectationsByInjectTypeData = [
    {
      ...
      data: sortedInjectTypesWithScoreByNumber.map((a: InjectStore & { number: number }) => ({
...
export default ExpectationDistributionByInjectType;
