...
// Standard hooks
    ...
    useEffect(() => {
        switch (mode) {
            case 'structural': setValue('widget_config.widget_configuration_type', 'structural-histogram'); break;
            case 'temporal': setValue('widget_config.widget_configuration_type', 'temporal-histogram'); break;
        }
    }, [mode]);
