const getAuthorizedPerspectives = (): Map<string, string[]> => new Map([
  ...
  ['inject', ['base_tags_side', 'base_asset_side', 'base_asset_group_side', 'base_team_side']],
  ['simulation', ['base_tags_side', 'base_asset_side', 'base_asset_group_side', 'base_team_side']],
  ['scenario', ['base_tags_side', 'base_asset_side', 'base_asset_group_side', 'base_team_side']],
]);
