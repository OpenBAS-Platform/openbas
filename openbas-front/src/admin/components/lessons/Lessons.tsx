...
const Lessons: React.FC = () => {
  ...
  const {
    ...
    return {
      ...
      lessonsQuestions: exerciseId ? helper.getExerciseLessonsQuestions(exerciseId) : helper.getScenarioLessonsQuestions(scenarioId),
      lessonsAnswers: exerciseId ? helper.getExerciseLessonsAnswers(exerciseId) : helper.getScenarioLessonsAnswers(scenarioId),
