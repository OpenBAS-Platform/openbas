...
const Lessons: React.FC<Props> = ({
    ...
    // Context
    const {} = useContext(LessonContext);
    ...
    return (
        <div>
                        ...
                        <Grid container={true} spacing={3}>
                            ...
                            <Grid item={true} xs={6}>
                                ...
                                <Button
                                    ...
                                    variant="contained"
                                    component={Link}
                                    href={`/lessons/${source.id}?preview=true`}
                                >
                                    {t('Preview')}
                                </Button>
                            </Grid>
                ...
                <DialogContent style={{overflowX: 'hidden'}}>
                    <SendLessonsForm
                        ...
                        initialValues={{
                            ...
                            subject: t('[${source.name}] Lessons learned questionnaire'),
            ...
            <CreateLessonsCategory exerciseId={source.id}/>
        </div>
    );
};
