  ...
  @Query(
      value =
          "WITH "
              ...
              + "         array_agg(DISTINCT platform.scenario_platform) "
              + "           AS scenario_platforms "
              + "  FROM workflows w "
              ...
              + "reply_to AS ( "
              + "  SELECT scenario_id, "
              + "         array_agg(DISTINCT scenario_reply_to) "
              + "           FILTER (WHERE scenario_reply_to IS NOT NULL) AS scenario_reply_to "
              + "  FROM scenario_mails_reply_to "
              + "  WHERE scenario_id = :scenarioId "
              + "  GROUP BY scenario_id "
              + ") "
              + "SELECT s.*, "
