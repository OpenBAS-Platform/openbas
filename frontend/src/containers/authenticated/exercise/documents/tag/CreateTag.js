...
class CreateTag extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <FlatButton label="Create a new tag" primary={true} onClick={this.handleOpen.bind(this)}/>
                <Dialog
                    ...
                    <TagForm ref="tagForm" onSubmit={this.onSubmit.bind(this)} onSubmitSuccess={this.handleClose.bind(this)}/>
                </Dialog>
            </div>
        )
    }
