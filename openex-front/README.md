...
The following repository is used to store the OpenEx frontend module.
...
**Unless specified otherwise**, openex-front are released under the [Apache 2.0](https://github.com/OpenEx-Platform/injectors/blob/master/LICENSE).
