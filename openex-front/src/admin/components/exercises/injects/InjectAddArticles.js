...
import { fetchExerciseArticles } from '../../../../actions/Media';
                    ...
                    return (
                      ...
                      >
                        ...
                        <ListItemText
                          ...
                          secondary={article.article_description}
                        />
                        <ItemTags variant="list" tags={article.article_tags} />
                      </ListItem>
                    );
                  })}
                  <CreateArticle
...
const select = (state, ownProps) => {
  ...
  return { exercise, articles, articlesMap };
};

export default R.compose(
  connect(select, { fetchExerciseArticles }),
  inject18n,
  withStyles(styles),
)(InjectAddArticles);
