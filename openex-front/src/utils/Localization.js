...
const i18n = {
  messages: {
    fr: {
      ...
      'Can be done in group': 'Peut être réalisé en groupe',
      MANUAL: 'Manuel',
      ...
      'Targeted endpoints': 'Endpoints ciblés',
      'Add endpoints': 'Ajouter des endpoints',
      'Add endpoints in this inject': 'Ajouter des endpoints dans ce stimuli',
      // Asset groups
      ...
      'Manage endpoints': 'Gérer les endpoints',
      'Add endpoints in this asset group': 'Ajouter des endpoints dans ce groupe d\'actifs',
