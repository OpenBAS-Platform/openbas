...
public class V2_4__Creation_update_cleanup extends BaseJavaMigration {
    ...
    public void migrate(Context context) throws Exception {
        ...
        // exercise
        select.execute("ALTER TABLE exercises ADD exercise_created_at timestamp not null default now();");
        select.execute("ALTER TABLE exercises ADD exercise_updated_at timestamp not null default now();");
        // user
