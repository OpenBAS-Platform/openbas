...
public class V2_21__Comcheck_refactor extends BaseJavaMigration {
    ...
    public void migrate(Context context) throws Exception {
        ...
        select.execute("ALTER TABLE injects_statuses RENAME COLUMN status_message TO status_reporting;");
        select.execute("ALTER TABLE dryinjects_statuses RENAME COLUMN status_message TO status_reporting;");
    }
}
