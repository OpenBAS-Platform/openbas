...
public class InjectExpectationSignature {
  ...
  public static final String EXPECTATION_SIGNATURE_TYPE_SOURCE_IP_ADDRESS = "source_ipv4_address";
  public static final String EXPECTATION_SIGNATURE_TYPE_TARGET_IP_ADDRESS = "target_ipv4_address";
  public static final String EXPECTATION_SIGNATURE_TYPE_TARGET_HOSTNAME_ADDRESS =
      "target_hostname_address";

  //  public static final String EXPECTATION_SIGNATURE_TYPE_START_DATE = "target_ipv4_address";
  //  public static final String EXPECTATION_SIGNATURE_TYPE_END_DATE = "target_ipv4_address";
