...
public enum Capability {
  ...
  ACCESS_ASSETS(null, pair(ResourceType.ASSET, Action.READ)),
  MANAGE_ASSETS(ACCESS_ASSETS, pair(ResourceType.ASSET, Action.WRITE)),
  DELETE_ASSETS(MANAGE_ASSETS, pair(ResourceType.ASSET, Action.DELETE)),

  // Payloads
  ACCESS_PAYLOADS(null, pair(ResourceType.PAYLOAD, Action.READ)),
  ...
  // Dashboards
  ACCESS_DASHBOARDS(null, pair(ResourceType.DASHBOARD, Action.READ)),
  ...
  // Findings
  ACCESS_FINDINGS(null, pair(ResourceType.FINDING, Action.READ)),
  ...
  // Documents
  ACCESS_DOCUMENTS(null, pair(ResourceType.DOCUMENT, Action.READ)),
  ...
  // Channels
  ACCESS_CHANNELS(null, pair(ResourceType.CHANNEL, Action.READ)),
  ...
  // Challenges
  ACCESS_CHALLENGES(null, pair(ResourceType.CHALLENGE, Action.READ)),
  ...
  // Lessons Learned
  ACCESS_LESSONS_LEARNED(null, pair(ResourceType.LESSON_LEARNED, Action.READ)),
  ...
  // Security Platforms
  ACCESS_SECURITY_PLATFORMS(null, pair(ResourceType.SECURITY_PLATFORM, Action.READ)),
  ...
  // Platform Settings
  ACCESS_PLATFORM_SETTINGS(null, pair(ResourceType.PLATFORM_SETTING, Action.READ)),
  MANAGE_PLATFORM_SETTINGS(
      ACCESS_PLATFORM_SETTINGS, pair(ResourceType.PLATFORM_SETTING, Action.WRITE));
