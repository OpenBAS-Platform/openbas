  ...
  @Query(
      value =
          "SELECT f.inject_id, f.inject_title, f.inject_scenario, f.inject_exercise, f.inject_created_at, f.inject_updated_at, f.inject_injector_contract, "
              ...
              + "FROM injects f "
              + "LEFT JOIN injects_executions ins ON ins.execution_inject = f.inject_id "
  ...
  @Query(
      value =
          "select icap.attack_pattern_id, count(distinct i) as countInjects from injects i "
              ...
              + "join injects_executions injectStatus ON injectStatus.execution_inject = i.inject_id "
  ...
  @Query(
      value =
          " SELECT injects.inject_id, ins.status_name, injects.inject_scenario, "
              ...
              + "LEFT JOIN injects_executions ins ON ins.execution_inject = injects.inject_id "
